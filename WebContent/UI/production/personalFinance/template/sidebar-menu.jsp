<div class="left_col scroll-view">
	<div class="navbar nav_title" style="border: 0;">
		<a href="/" class="site_title"
			style="padding-left: 0; background: #d7d7d7; text-align: center;"><img
			src="UI/production/images/logo.png" style="width: 64px;"> <span
			style="font-size: 19px; color: #58595a; font-weight: 700; margin-left: -14px;">Personal
				Finance</span></a>
	</div>
	...
	<div class="profile">
		<div class="profile_pic">
			<img src="UI/production/images/img.jpg" alt="..."
	...
	<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
		<div class="menu_section">
			...
			<ul class="nav side-menu">
				...
				<li><a  href="PortfolioManager"><i class="fa fa-edit"></i> Bank </a>
					</li>
				<li><a  href="MFManager"><i class="fa fa-desktop"></i> MF </a>
					</li>
