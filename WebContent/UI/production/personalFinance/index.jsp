			...
			<div class="right_col" role="main">
				...
				<div class="row tile_count">
					<div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
						<span class="count_top"><i class="fa fa-user"></i> Net
							Worth</span>
					...
					<div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
						...
						<span class="count_bottom"><i class="green"><i
								class="fa fa-sort-asc"></i>3.4% </i> From last Week</span>
					</div>
					<div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
						<span class="count_top"><i class="fa fa-user"></i> Gain
							Percentage</span>
						<div class="count">27.8%</div>
						<span class="count_bottom"><i class="red"><i
								class="fa fa-sort-desc"></i>17.2% </i> per annum</span>
					</div>
					<div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
						<span class="count_top"><i class="fa fa-user"></i> Today's
							Gain</span>
						<div class="count">2,315</div>
						<span class="count_bottom"><i class="green"><i
								class="fa fa-sort-asc"></i>3.4% </i> today</span>
					</div>
					<div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
						<span class="count_top"><i class="fa fa-user"></i> Advice</span>
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="dashboard_graph">
							...
							<div class="row x_title">
								<div class="col-md-6">
									<h3>
										Your Growth <small>Compare your growth</small>
									</h3>
								</div>
								<div class="col-md-6">
										...
										<td>
											<table class="tile_info">
												<tr>
													<td>
														<p>
															<i class="fa fa-square blue"></i>FD
														</p>
													</td>
													<td>30%</td>
												</tr>
												<tr>
													<td>
														<p>
															<i class="fa fa-square green"></i>Debt Fund
														</p>
													</td>
													<td>10%</td>
												</tr>
												<tr>
													<td>
														<p>
															<i class="fa fa-square purple"></i>Balenced
														</p>
													</td>
													<td>20%</td>
												</tr>
												<tr>
													<td>
														<p>
															<i class="fa fa-square aero"></i>Equity
														</p>
													</td>
													<td>15%</td>
												</tr>
						...
						<div class="x_panel tile fixed_height_320">
							...
							<div class="x_content">
								<div class="dashboard-widget-content"
									...
									<div class="sidebar-widget" style="float: none;">
										<h4>Personalized Risk profile</h4>
										<canvas width="150" height="80" id="foo" class=""
											style="width: 85%;"></canvas>
										<div class="goal-wrapper">
											<span id="gauge-text" class="gauge-value pull-left">Safe</span>
											<span id="goal-text" class="goal-value pull-right">Risky</span>
										</div>
									</div>
								</div>
							</div>
